...
export const servicesData = [
  {
    id: 1,
    title: "Web Development Services for Small Businesses in Chicago",
    image: Web,
  ...
  {
    id: 2,
    title: "User-Centric UI/UX Design to Enhance Customer Engagement",
    image: UX,
    alt: "UI/UX design for small business websites in Chicago icon",
    description:
      "I craft stunning, user-friendly designs that captivate your customers. By focusing on intuitive layouts and seamless user experiences that will turn user into customers.",
  ...
  },
  {
    ...
    description:
      "Enhance your online presence with professional SEO services. I improve your search engine rankings, driving more organic traffic to your website.",
