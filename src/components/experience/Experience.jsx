        ...
        <div className="card-exp">
          <div className="experience-item">
            ...
            <p className="exp-summary">
              As a Junior Full Stack Developer, I significantly contributed to
              an e-commerce platform's development, showcasing my ability to
              apply academic knowledge to practical tech industry challenges.
            </p>
